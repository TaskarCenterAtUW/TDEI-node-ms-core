...
import { ResourceErrorPayload } from '../../utils/resource-errors/abstract-resource-error';
...
export abstract class AbstractDomainEntity {
  ...
  public static from<T>(
    ...
    forEach<string>(Reflect.getMetadata('modelProps', model as Object), (propName : any) => {
   ...
   * @param prop
   */
  private getPropValue(prop : any): any {
